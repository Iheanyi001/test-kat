<section class="sec-pad-top testimonials-one testimonials-one--bottom-pd-lg">
    ...
    <div class="testimonials-one__gallery">
       <!--<img style="width: 70px; height: 70px; border-radius: 50%;" src="<?php echo e(asset('images/test1.png')); ?>" alt="Gallery Image 1" class="float-bob-x">
       <img style="width: 70px; height: 70px; border-radius: 50%;" src="<?php echo e(asset('images/test3.png')); ?>" alt="Gallery Image 2" class="float-bob-x">
       <img style="width: 70px; height: 70px; border-radius: 50%;" src="<?php echo e(asset('images/test2.png')); ?>" alt="Gallery Image 3" class="float-bob-x">
       <img style="width: 70px; height: 70px; border-radius: 50%;" src="<?php echo e(asset('images/test4.png')); ?>" class="float-bob-x">
       -->
    </div>
    <div class="container">
                   ...
                   <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                         ...
                         <div class="testimonials-card" 84118bfd>
                            ...
                            <img src="<?php echo e(asset('_nuxt/testimonials-item-bg-1-1.BkqDuzSL.png')); ?>" class="testimonials-card__bg" alt="" 84118bfd>
...
<?php /**PATH F:\downloads\acopy\resources\views/components/testimonials.blade.php ENDPATH**/ ?>