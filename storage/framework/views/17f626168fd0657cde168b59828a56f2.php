...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/logo-icon.png')); ?>">
        ...
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/style.css']); ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('libs/toastr/toastr.css')); ?>">
        <!-- Styles -->
...
.my-join-us-btn:after, .my-join-us-btn:before{
    ...
    <body>
                     ...
                     <div>
                        <header class="main-header">
                           ...
                           <nav class="main-menu sticky-header">
                              <div class="container-fluid">
                                 <a aria-current="page" href="<?php echo e(route('home')); ?>" class="router-link-active router-link-exact-active main-header__logo">
                                    <img src="<?php echo e(asset('images/logo.png')); ?>" width="250" height="49" alt></a>
                                 <ul class="main-menu__list">
                                    <!--[-->
                                    <li class="dropdown">
                                       <a aria-current="page" href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'router-link-active router-link-exact-active': ''); ?>">Home</a>
                                    </li>

                                    <li class="dropdown">
                                        <a href="<?php echo e(route('about')); ?>" class="<?php echo e(request()->routeIs('about') ? 'router-link-active router-link-exact-active': ''); ?>">About Us</a>
                                     </li>

                                    <li class="dropdown">
                                       <a href="<?php echo e(route('events')); ?>" class="<?php echo e(request()->routeIs('events') ? 'router-link-active router-link-exact-active': ''); ?>">Events</a>
                                    </li>

                                    <li class="dropdown">
                                        <a href="<?php echo e(route('donate')); ?>" class="<?php echo e(request()->routeIs('donate') ? 'router-link-active router-link-exact-active': ''); ?>">Donations</a>
                                     </li>

                                    <li class="">
                                       <a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'router-link-active router-link-exact-active': ''); ?>">Contact Us</a><!---->
                                    </li>
                                 ...
                                 <div class="main-menu__right">
                                    <div class="main-menu__cta">
                                       ...
                                       <div class="main-menu__cta__text"><span>Join us now</span><a href="<?php echo e(route('contact')); ?>" class="">Become a Volunteer</a></div>
                                    </div>
                                    <a href="<?php echo e(route('donate')); ?>" class="thm-btn thm-btn--two">
        ...
        <footer class="site-footer" style="background-image:url(<?php echo e(asset('_nuxt/footer-bg-1-1.DQ6J-Ydo.jpg')); ?>);" data-v-637754db>
                  ...
                  <div class="row" data-v-637754db>
                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="000ms" data-v-637754db>
                        <div class="site-footer__widget site-footer__widget__about" data-v-637754db>
                           <a aria-current="page" href="<?php echo e(route('home')); ?>" class="router-link-active router-link-exact-active site-footer__widget__logo" data-v-637754db>
                            <img src="<?php echo e(asset('images/logo-white.png')); ?>" width="250" height="49" alt="Logo" data-v-637754db></a>
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms" data-v-637754db>
                        <div class="site-footer__widget" data-v-637754db>
                           ...
                           <ul class="list-unstyled site-footer__widget__links" data-v-637754db>
                              <li data-v-637754db><a href="<?php echo e(route('home')); ?>" class="" data-v-637754db>Home</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('about')); ?>" class="" data-v-637754db>About us</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('donate')); ?>" class="" data-v-637754db>Donate</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('events')); ?>" class="" data-v-637754db>Events</a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms" data-v-637754db>
                        <div class="non-profile-container site-footer__widget" data-v-637754db>
                           ...
                           <ul class="list-unstyled site-footer__widget__links" data-v-637754db>
                              <li data-v-637754db><a href="<?php echo e(route('support.medical')); ?>" class="" data-v-637754db>Medical</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('support.education')); ?>" class="" data-v-637754db>Educational</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('support.poverty')); ?>" class="" data-v-637754db>Poverty Alleviation</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('support.youth')); ?>" class="" data-v-637754db>Youth Empowerment</a></li>
                              <li data-v-637754db><a href="<?php echo e(route('support.environment')); ?>" class="" data-v-637754db>Environmental Sustainability</a></li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                        <div class="site-footer__widget site-footer__widget__cta">
                           ...
                           <a href="<?php echo e(route('donate')); ?>" class="thm-btn thm-btn--two thm-btn--light"><span>Donate Now</span><i class="fa fa-heart" data-v-637754db></i></a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div id="mobile-nav__wrapper" class="mobile-nav__wrapper" >
            ...
            <div class="mobile-nav__content" >
               ...
               <div class="logo-box" ><a aria-current="page" href="<?php echo e(route('home')); ?>" class="router-link-active router-link-exact-active" aria-label="logo image" >
                <img src="<?php echo e(asset('images/logo-white.png')); ?>" width="250" height="49" alt="KAT Foundation" ></a></div>
               <div class="mobile-nav__container" >
                  <ul class="mobile-menu__list" >
                     ...
                     <li class="menu-item-has-children" >
                        <a href="<?php echo e(route('donate')); ?>" >Donate </a>
               ...
               <ul class="mobile-nav__social" >
                  <li ><a href="<?php echo e(route('home')); ?>" ><i class="fab fa-twitter" ></i></a></li>
...
<script src="<?php echo e(asset('libs/toastr/toastr.js')); ?>"></script>
...
<?php /**PATH /home/pemsaknw/kingateketomfoundation.org/resources/views/layouts/guest.blade.php ENDPATH**/ ?>