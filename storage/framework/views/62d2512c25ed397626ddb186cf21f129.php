                        ...
                        <div class="pre-amnesty swiper" style="width: 100%; height: 100%">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty1.jpg')); ?>" alt="Image 1">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty2.jpg')); ?>" alt="Image 2">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty3.jpg')); ?>" alt="Image 3">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty4.jpg')); ?>" alt="Image 4">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty5.jpg')); ?>" alt="Image 5">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty6.jpeg')); ?>" alt="Image 6">
                                </div>
                                <div class="swiper-slide">
                                    <img class="my-img" src="<?php echo e(asset('images/anm/pre-amnesty7.jpg')); ?>" alt="Image 7">
                                </div>
                            </div>
                        </div>
                    </div>
           ...
           <div class="row">
            ...
            <div class="col-lg-6" style="overflow: hidden; height: 408px">
                <div class="post-amnesty swiper" style="width: 100%; height: 100%">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty1.jpg')); ?>" alt="Image 1">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty2.jpg')); ?>" alt="Image 2">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty3.jpg')); ?>" alt="Image 3">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty4.jpg')); ?>" alt="Image 4">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty5.jpg')); ?>" alt="Image 5">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty6.jpg')); ?>" alt="Image 6">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty8.jpg')); ?>" alt="Image 8">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty9.jpg')); ?>" alt="Image 9">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty10.jpg')); ?>" alt="Image 10">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty11.jpg')); ?>" alt="Image 11">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty12.jpg')); ?>" alt="Image 12">
                        </div>
                        <div class="swiper-slide">
                            <img class="my-img" src="<?php echo e(asset('images/anm/post-amnesty13.jpg')); ?>" alt="Image 13">
                        </div>
                    </div>
                </div>
            </div>
           ...
           <div class="row gutter-y-30 mt-4">
            ...
            <ul class="list-unstyled funfact-two__list" >
                <li class="funfact-two__list__item" >
                   <a style="color:var(--paroti-black,#144047)" href="<?php echo e(route('support.medical')); ?>">
                   <div class="funfact-two__list__icon" >
                    <img style="width:70px" src="<?php echo e(asset('images/med-icon.png')); ?>" alt="Medical Outreach" >
                </div>
                ...
                <li class="funfact-two__list__item" style="--accent-color:#8139e7;" >
                    <a style="color:var(--paroti-black,#144047)" href="<?php echo e(route('support.environment')); ?>">
                    <div class="funfact-two__list__icon" >
                        <img style="width:70px" src="<?php echo e(asset('images/env-icon.png')); ?>" alt="Environment" >
                    </div>
                    <h3 class="funfact-two__list__count count-box" >
                       <div class="countup-wrap" >
                          <!--[--><!--]--><span></span><!--[--><!--]-->
                ...
                <li class="funfact-two__list__item" >
                    <a style="color:var(--paroti-black,#144047)" href="<?php echo e(route('support.youth')); ?>">
                    <div class="funfact-two__list__icon" >
                        <img style="width:70px" src="<?php echo e(asset('images/youth-icon.png')); ?>" alt="">
                    </div>
                    <h3 class="funfact-two__list__count count-box" >
                       <div class="countup-wrap" >
                          <span></span>
                ...
                <li class="funfact-two__list__item" style="--accent-color:#fdbe44;" >
                    <a style="color:var(--paroti-black,#144047)" href="<?php echo e(route('support.poverty')); ?>">
                   <div class="funfact-two__list__icon" >
                    <img style="width:70px" src="<?php echo e(asset('images/poor-icon.png')); ?>" alt="Poverty Alleviation" >
                    </div>
                   <h3 class="funfact-two__list__count count-box" >
                      <div class="countup-wrap" >
                         <!--[--><!--]--><span></span><!--[--><!--]-->
                ...
                <li class="funfact-two__list__item" style="--accent-color:#138999;" >
                    <a style="color:var(--paroti-black,#144047)" href="<?php echo e(route('support.education')); ?>">
                   <div class="funfact-two__list__icon" >
                    <img style="width:70px" src="<?php echo e(asset('images/edu-icon.png')); ?>" alt="Educational Support"/>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/pemsaknw/kingateketomfoundation.org/resources/views/about.blade.php ENDPATH**/ ?>