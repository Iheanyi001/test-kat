        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar avatar-online">
              ...
              <img src="{{(auth()->user()->photo_path) ? Storage::url(auth()->user()->photo_path) : asset('assets/img/avatars/1.png')}}" alt class="h-auto rounded-circle">
            </div>
          </a>
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar avatar-online">
                     ...
                     <div class="h-auto rounded-circle">{{substr(Auth::user()->first_name, 0, 1)}}</div>
                    </div>
                  </div>
