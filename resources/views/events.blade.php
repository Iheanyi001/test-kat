        ...
        <div class="container">
           <div class="row gutter-y-30">
              <div class="col-md-12 col-lg-4">
                 <div class="events-card">
                    <div class="events-card__image">
                        <img style="height: 426px;" src="{{asset('images/bese/7.jpg')}}" alt="">
                        <img style="height: 426px;" src="{{asset('images/bese/7.jpg')}}" class="events-card__image--hover" alt="">
                    </div>
                    <div class="events-card__content">
                       ...
                       <h3 class="events-card__title">
                           <a href="{{route('events.previous.bese.2024')}}" class="">
              ...
              <div class="col-md-12 col-lg-4">
                 <div class="events-card">
                    <div class="events-card__image">
                        <img style="height: 426px;" src="{{asset('images/edu_program/3.jpg')}}" alt="">
                        <img style="height: 426px;" src="{{asset('images/edu_program/3.jpg')}}" class="events-card__image--hover" alt="">
                    </div>
                    <div class="events-card__content">
                       ...
                       <h3 class="events-card__title">
                           <a href="{{route('events.previous.two-school-visit-2024')}}" class="">
              ...
              <div class="col-md-12 col-lg-4">
                 <div class="events-card">
                    <div class="events-card__image">
                        <img style="height: 426px;" src="{{asset('images/courtesy_visit/2.jpg')}}" alt="">
                        <img style="height: 426px;" src="{{asset('images/courtesy_visit/2.jpg')}}" class="events-card__image--hover" alt="">
                    </div>
                    <div class="events-card__content">
                       ...
                       <h3 class="events-card__title">
                           <a href="{{route('events.previous.courtesy-visit-2024')}}" class="">
