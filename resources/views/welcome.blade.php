           ...
           <div class="row gutter-y-60">
              <div class="col-md-12 col-lg-6" >
                 <div class="about-two__image" >
                    ...
                    <img loading="lazy" src="{{asset('images/king2.png')}}" class="wow fadeInLeft" data-wow-duration="1500ms" alt="" >
           ...
           <div class="donations-carousel">
                <div class="my-slider">
                    <div  aria-hidden="true" tabindex="-1">
                        <div class="donations-card" style="--accent-color: #df5311;">
                            <div class="donations-card__image">
                                <img loading="lazy" style="height: 252px" src="{{asset('images/med_program/img3.jpg')}}" alt="Donation Image">
                    ...
                    <div  aria-hidden="true" tabindex="-1">
                        <div class="donations-card" style="--accent-color: #df5311;">
                            <div class="donations-card__image">
                            <img loading="lazy" style="height: 252px" src="{{asset('images/youth/1.png')}}" alt="Donation Image">
                            <div class="donations-card__category">
                    ...
                    <div  aria-hidden="true" tabindex="-1">
                        <div class="donations-card" style="--accent-color: #df5311;">
                            <div class="donations-card__image">
                            <img loading="lazy" style="height: 252px" src="{{asset('images/poverty/2.png')}}" alt="Donation Image">
                            <div class="donations-card__category">
                    ...
                    <div  aria-hidden="true" tabindex="-1">
                        <div class="donations-card" style="--accent-color: #df5311;">
                            <div class="donations-card__image">
                            <img loading="lazy" style="height: 252px" src="{{asset('images/edu_program/1.jpg')}}" alt="Donation Image">
                            <div class="donations-card__category">
                    ...
                    <div  aria-hidden="true" tabindex="-1">
                        <div class="donations-card" style="--accent-color: #df5311;">
                            <div class="donations-card__image">
                            <img loading="lazy" style="height: 252px" src="{{asset('images/environment/1.jpg')}}" alt="Donation Image">
                            <div class="donations-card__category">
           ...
           <div class="swiper3" >
              ...
              <div class="swiper-wrapper">
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="0" >
                    ...
                    <div class="gallery-card">
                       <div class="gallery-card__image">
                        <img loading="lazy" style="height:192px"  src="{{asset('images/edu_program/3.jpg')}}" alt="#"></div>
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="1" >
                    ...
                    <div class="gallery-card" >
                       <div  class="gallery-card__image">
                        <img loading="lazy" style="height:192px" src="{{asset('images/med_program/img2.jpg')}}" alt="#"></div>
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="2" >
                    ...
                    <div class="gallery-card" >
                       <div class="gallery-card__image">
                        <img loading="lazy" style="height:192px" src="{{asset('images/health_program/4.jpg')}}" alt="#"></div>
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="3" >
                    ...
                    <div class="gallery-card">
                       <div  class="gallery-card__image">
                        <img loading="lazy" style="height:192px" src="{{asset('images/edu_program/13.jpg')}}" alt="#"></div>
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="4" >
                    ...
                    <div class="gallery-card">
                       <div class="gallery-card__image">
                        <img loading="lazy" style="height:192px" src="{{asset('images/med_program/img8.jpg')}}" alt="#"></div>
                 ...
                 <div class="swiper-slide" data-swiper-slide-index="6" 1987b388>
                    ...
                    <div class="gallery-card">
                        <div class="gallery-card__image" >
                            <img loading="lazy" style="height:192px" src="{{asset('images/edu_program/2.jpg')}}" alt="#" >
                        </div>
           ...
           <div class="row gutter-y-30">
              <div class="col-md-6 col-lg-4">
                 <div class="volunteers-card">
                    ...
                    <div class="volunteers-card__image"><img loading="lazy" src="{{asset('images/king1.png')}}" alt=""></div>
              ...
              <div class="col-md-6 col-lg-4">
                 <div class="volunteers-card">
                    ...
                    <div class="volunteers-card__image">
                        <img loading="lazy" style="height: 353px;" src="{{asset('images/trustee1.png')}}" alt="">
                    </div>
              ...
              <div class="col-md-6 col-lg-4">
                 <div class="volunteers-card">
                    ...
                    <div class="volunteers-card__image">
                        <img loading="lazy" src="{{asset('images/trustee2.png')}}" alt="">
                    </div>
                    <div class="volunteers-card__social"><a href="#"><i class="fab fa-twitter"></i></a><a href="#"><i class="fab fa-facebook"></i></a><a href="#"><i class="fab fa-pinterest"></i></a><a href="#"><i class="fab fa-instagram"></i></a></div>
                 </div>
              </div>
           ...
           <div class="row gutter-y-30">
            <div class="col-md-6 col-lg-4">
                <div class="volunteers-card">
                   ...
                   <div class="volunteers-card__image">
                       <img loading="lazy" style="height: 350px; width: 85%;" src="{{asset('images/exe-sec.jpg')}}" alt="">
                   </div>
              ...
              <div class="col-md-6 col-lg-8">
                 <img loading="lazy" style="width:100%" src="{{asset('images/team.jpg')}}" alt=""/>
              </div>
           </div>
        </div>
     </section>
                ...
                <div class="my-slider2">
                    <div class="blog-card">
                        <div class="blog-card__image">
                            <img loading="lazy" style="height: 282px" src="{{asset('images/med_program/img8.jpg')}}" alt="Online legal advice for asylum seekers in Greece">
                    ...
                    <div class="blog-card">
                        <div class="blog-card__image">
                            <img loading="lazy" style="height: 282px" src="{{asset('images/edu_program/14.jpg')}}" alt="Online legal advice for asylum seekers in Greece">
                            <div class="blog-card__date">
                                <span>10</span>Nov
                            </div>
                        </div>
                    ...
                    <div class="blog-card">
                        <div class="blog-card__image">
                            <img loading="lazy" style="height: 282px" src="{{asset('images/green.webp
