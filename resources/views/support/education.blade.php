                    ...
                    <div class="pre-amnesty" style="width:100%">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{asset('images/edu_program/1.jpg')}}" alt="Image 1">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{asset('images/edu_program/2.jpg')}}" alt="Image 2">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{asset('images/edu_program/3.jpg')}}" alt="Image 3">
                            </div>

                            <div class="swiper-slide">
                              <img src="{{asset('images/edu_program/4.jpg')}}" alt="Image 3">
                          </div>


                                <div class="swiper-slide">
                                    <img src="{{asset('images/edu_program/5.jpg')}}" alt="Image 5">
                                </div>
